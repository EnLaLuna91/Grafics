...
BlinnPhong::BlinnPhong(const glm::vec3 &_obs, const Light &_light,	const glm::vec3 &_ambientLight):
    obs(_obs),
    light(_light),
...
glm::vec3 BlinnPhong::obtainBlinnPhong(const IntersectInfo &_info){
	this->info = _info;
